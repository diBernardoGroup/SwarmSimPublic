...
tags = ["switch_1","switch_5","switch_10","ramp", "OFF","75_ON", "150_ON", "255_ON"];
sim_names = ["2024_07_09_switch_1_1", "2024_07_09_switch_5_1", "2024_07_09_switch_10_16", "2024_07_09_ramp_1", "2024_07_09_OFF_1", "2024_07_09_75_ON_1", "2024_07_09_150_ON_1", "2024_07_09_255_ON_1"]';
experiments_names = ["comparisons/Euglena_switch_1/combo", "2023_06_15_Euglena_11", "2023_06_26_Euglena_28", "2023_07_10_Euglena_19";
    "comparisons/Euglena_switch_5/combo", "2023_06_15_Euglena_8", "2023_06_26_Euglena_25", "2023_07_10_Euglena_18";
...
if size(experiments_names,1) > 1 % multi-exp comparison
    ...
    for i = 1:size(experiments_names,1)  % for each experiment
        ...
        ylim([0,100])
        %Draw the inputs
        highlightInputs_v2(timeInstants, u{i},[Render.cmap_inputs(end,:);Render.cmap_inputs(1,:)], 0.7);
