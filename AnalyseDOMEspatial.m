...
tag='mix'; experiments = {'2023_07_10_E_34','2023_06_26_E_11','2023_07_10_E_26','2023_06_23_E_9','2023_06_14_E_7','2023_06_14_Euglena_6'};  
...
u = movmean2(u,51);
Inputs.Points = {linspace(window(1),window(2),size(inputs,2)), linspace(window(3),window(4),size(inputs,1))};
Inputs.Values = u;
