...
Dynamics=struct('model','IndependentSDEsWithInput', ...
    'avgSpeed',agents.mu_s, 'rateSpeed', agents.theta_s, 'sigmaSpeed', agents.sigma_s, 'gainSpeed', 5, 'gainDerSpeed', 0,...
    'rateOmega', agents.theta_w, 'sigmaOmega', agents.sigma_w, 'gainOmega', -1, 'gainDerOmega', 0,...
    'omega', normrnd(0,agents.std_w,N,1), 'oldInput', zeros(N,1));
