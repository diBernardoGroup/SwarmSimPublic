...
Dynamics=struct('model','CoupledSDEs', 'rateSpeed', 1, 'avgSpeed', avgSpeed0, 'sigmaSpeed', 1, 'rateOmega', 1, 'sigmaOmega', @(x)1, 'omega', zeros(N,1));
...
x0=randCircle(N, 5);                 % initial conditions drawn from a uniform disc
...
%% Run Simulation
[xVec] = Simulator(x0, v0, Simulation, Dynamics, drawON, getMetrics, GlobalIntFunction, LocalIntFunction);
